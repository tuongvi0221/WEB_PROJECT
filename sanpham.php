    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="main-prd">
                ...
                <img src="<?php echo htmlspecialchars($row['anhphu']); ?>" class="main-prd-img"
                ...
                <div class="basic-info">
                    ...
                    <ul>
                        ...
                        <li><span class="km">Khuyến mãi: <?php echo htmlspecialchars($row['khuyenmai']); ?></span>
                        </li>
                        <br><a class="btn btn-primary"
                            href="order.php?masp=<?php echo htmlspecialchars($masp_safe); ?>">Mua ngay</a>
                    </ul>
                </div>
            </div>
